// Find bug in the router configuration
// Check if all the imported components have correct paths

// Import statements

import { createRouter, createWebHistory } from "vue-router";
import PresentationView from "../views/Presentation/PresentationView.vue";
import AP_Page_Counter from "../layouts/sections/page-sections/AP_Page_Counter.vue";
import STA_Page_Counter from "../layouts/sections/page-sections/STA_Page_Counter.vue";
import Env_Page_Counter from "../layouts/sections/page-sections/Env_Page_Counter.vue";
import WAC_Page_Counter from "../layouts/sections/page-sections/WAC_Page_Counter.vue";
...
const router = createRouter({
  ...
  routes: [
    {
      path: '/Environment',
      component: Env_Page_Counter
    },
    {
      path: '/WAC/roaming/:id',
      component: WAC_Page_Counter
    },
    {
      path: '/AP/roaming/:id',
      component: AP_Page_Counter
    },
    {
      path: '/STA/roaming/:id',
      component: STA_Page_Counter
    },
    {
      path: "/",
      name: "presentation",
